...
You will output the notes in the following JSON format:
{
    ...
    "todos": "1. \n 2. \n 3. \n",
    "reflection": "Add a maximum of three reflection questions here.",
    "tags": "Return a string list of maximum four tags out of these that describe the sentiment of the body: ${tags.join(
      ", "
    )}.",
}
